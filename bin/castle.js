...
Level.prototype = {
	...
	,onKey: function(e) {
		...
		if(e.ctrlKey || new js.JQuery("input[type=text]:focus").length > 0 || this.currentLayer == null) return;
		new js.JQuery(".popup").remove();
		var l = this.currentLayer;
		var _g = e.keyCode;
		switch(_g) {
	...
	,save: function() {
		if(this.mouseDown || this.deleteMode != null) {
			this.needSave = true;
			return;
		}
		this.needSave = false;
				...
				t4.find("[name=tags]").html(((function($this) {
					...
					var _g8 = [];
					{
						...
						while(_g18 < _g23.length) {
							var t5 = _g23[_g18];
							++_g18;
							_g8.push("<option value=\"" + t5.name + "\">" + t5.name + "</option>");
						}
					}
					$r = _g8;
					return $r;
