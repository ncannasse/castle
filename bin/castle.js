	...
	,handleSpecial: function(e,name,args,result) {
		...
		case "startDrag":
			...
			var onMove = function(e1) {
				result({ dx : e1.webkitMovementX, dy : e1.webkitMovementY});
			};
			var onUp = function() {
			...
			var onChange1 = null;
			onChange1 = function() {
				if(document.webkitPointerLockElement == e) {
					document.addEventListener("mousemove",onMove,false);
					document.addEventListener("mouseup",onUp,false);
				} else {
					result({ dx : 0, dy : 0, done : true});
					document.removeEventListener("webkitpointerlockchange",onChange1,false);
	...
	,editCell: function(c,v,sheet,index) {
		...
		};
		{
			...
			case 2:
				...
				break;
			case 7:
				var i3 = $("<input>").attr("type","file").css("display","none").change(function(e7) {
					var j = $(this);
					var file = j.val();
...
cdb_jq_Message.CreateText = function(id,text,pid) { var $x = ["CreateText",4,id,text,pid]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.Reset = function(id) { var $x = ["Reset",5,id]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.Dock = function(pid,id,dir,size) { var $x = ["Dock",6,pid,id,dir,size]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.Remove = function(id) { var $x = ["Remove",7,id]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.Event = function(id,name,eid) { var $x = ["Event",8,id,name,eid]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.SetAttr = function(id,att,val) { var $x = ["SetAttr",9,id,att,val]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.SetStyle = function(id,st,val) { var $x = ["SetStyle",10,id,st,val]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.Trigger = function(id,name) { var $x = ["Trigger",11,id,name]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.Special = function(id,name,args,eid) { var $x = ["Special",12,id,name,args,eid]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.Anim = function(id,name,dur) { var $x = ["Anim",13,id,name,dur]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.Dispose = function(id,events) { var $x = ["Dispose",14,id,events]; $x.__enum__ = cdb_jq_Message; return $x; };
cdb_jq_Message.Unbind = function(events) { var $x = ["Unbind",15,events]; $x.__enum__ = cdb_jq_Message; return $x; };
