...
Level.prototype = {
	...
	,onKey: function(e) {
		...
		switch(e.keyCode) {
		case 9:
			this.setLayer(this.layers[(this.layers.indexOf(l) + (e.shiftKey?this.layers.length - 1:1)) % this.layers.length]);
			e.preventDefault();
			e.stopPropagation();
			break;
		case 27:
	...
	,setLayer: function(l) {
		...
		tmp1.spectrum("set",this.toColor(l.props.color)).closest(".item").css({ display : tmp2});
		var _g1 = l.data;
		switch(_g1[1]) {
		case 2:
