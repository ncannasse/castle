			...
			fs.change(function(_) {
				...
				if(saveAs) {
					if(js_Boot.__instanceof(data,haxe_io_Bytes)) {
						...
						while(_g5 < _g4) _g3.push(data1.b[_g5++]);
						js_node_Fs.writeFileSync(path1,new js_node_buffer_Buffer(_g3));
					} else {
	...
	,init: function() {
		...
		while(_g2 < _g11.length) {
			...
			case 8:
				...
				if(tmp) {
					...
					while(_g31 < _g4.length) {
						...
						var _g5 = cid.type;
						if(_g5[1] == 6) {
							sid = this.model.smap.get(_g5[2]).s;
							idCol = cid.name;
							break;
						}
					}
			...
			case 12:
				...
				l2.loadSheetData(this.model.smap.get(_g3[2]).s);
				l2.setLayerData(val);
				this.layers.push(l2);
				break;
			case 15:
	...
	,getConvFunction: function(old,t) {
		...
		case 1:
			...
			case 0:case 6:case 12:
				r_invalid_r = new RegExp("[^A-Za-z0-9_]","g".split("u").join(""));
				conv = function(r) {
	...
	,valueHtml: function(c,v,sheet,obj) {
		...
		case 8:
			...
			while(_g2 < a.length) {
				...
				var vstr = v2;
				if(v2.indexOf("<") >= 0) {
					_this_r2 = new RegExp("<img src=\"[^\"]+\" style=\"display:none\"[^>]+>","g".split("u").join(""));
					vstr = vstr.replace(_this_r2,"");
					_this_r1 = new RegExp("<img src=\"[^\"]+\"/>","g".split("u").join(""));
					vstr = vstr.replace(_this_r1,"[I]");
					_this_r = new RegExp("<div id=\"[^>]+></div>","g".split("u").join(""));
					vstr = vstr.replace(_this_r,"[D]");
				}
				size += vstr.length;
				out.push(v2);
			}
	...
	,editCell: function(c,v,sheet,index) {
		...
		case 11:
			...
			spect.spectrum({ color : "#" + StringTools.hex(val,6), showInput : true, showButtons : false, change : function() {
				...
				val = color;
				obj[c.name] = color;
				var tmp1 = _gthis.valueHtml(c,val,sheet,obj);
				v.html(tmp1);
				_gthis.save();
			}}).spectrum("show");
			break;
		...
		case 0:case 1:case 3:case 4:case 9:case 16:
			...
			if(val != null) {
				...
				case 9:
					var t = _g6[2];
					var tmp2 = this.typeValToString(this.tmap.get(t),val);
					i6.val(tmp2);
					break;
				case 16:
					var tmp3 = JSON.stringify(val);
					i6.val(tmp3);
					break;
				default:
			...
			if(props == null) {
				...
				if((fbits & 1) != 0) {
					if(props.ctrlKey == null) {
						...
						ctx.out.b.push(1);
						ctx.out.b.push(props.ctrlKey ? 1 : 0);
					}
				}
				if((fbits & 2) != 0) {
					if(props.keyCode == null) {
				...
				if((fbits & 4) != 0) {
					if(props.shiftKey == null) {
						...
						ctx.out.b.push(1);
						ctx.out.b.push(props.shiftKey ? 1 : 0);
					}
				}
				if((fbits & 8) != 0) {
					if(props.target == null) {
	...
	if(v == null) {
		...
		case 1:
			...
			if(name1 == null) {
				...
				var b4 = haxe_io_Bytes.ofString(name1);
				var v7 = b4.length + 1;
				if(v7 >= 0 && v7 < 128) {
					ctx.out.b.push(v7);
				} else {
		...
		case 2:
			...
			if(name2 == null) {
				...
				var b5 = haxe_io_Bytes.ofString(name2);
				var v8 = b5.length + 1;
				if(v8 >= 0 && v8 < 128) {
					ctx.out.b.push(v8);
				} else {
		...
		case 5:
			...
			if(text == null) {
				...
				var b6 = haxe_io_Bytes.ofString(text);
				var v9 = b6.length + 1;
				if(v9 >= 0 && v9 < 128) {
					ctx.out.b.push(v9);
				} else {
				...
				var _g15 = 0;
				var _g7 = b6.length;
				while(_g15 < _g7) _this5.b.push(b25[_g15++]);
			}
			if(pid == null) {
				ctx.out.b.push(0);
			} else {
		...
		case 8:
			...
			if(name3 == null) {
				...
				var b7 = haxe_io_Bytes.ofString(name3);
				var v10 = b7.length + 1;
				if(v10 >= 0 && v10 < 128) {
					ctx.out.b.push(v10);
				} else {
				...
				var _g16 = 0;
				var _g8 = b7.length;
				while(_g16 < _g8) _this6.b.push(b26[_g16++]);
			}
			if(eid >= 0 && eid < 128) {
				ctx.out.b.push(eid);
			} else {
		...
		case 9:
			...
			if(att == null) {
				...
				var b8 = haxe_io_Bytes.ofString(att);
				var v11 = b8.length + 1;
				if(v11 >= 0 && v11 < 128) {
					ctx.out.b.push(v11);
				} else {
				...
				var _g17 = 0;
				var _g9 = b8.length;
				while(_g17 < _g9) _this7.b.push(b27[_g17++]);
			}
			if(val == null) {
				ctx.out.b.push(0);
			} else {
				var b9 = haxe_io_Bytes.ofString(val);
				var v12 = b9.length + 1;
				if(v12 >= 0 && v12 < 128) {
					ctx.out.b.push(v12);
				} else {
				...
				var _g18 = 0;
				var _g10 = b9.length;
				while(_g18 < _g10) _this8.b.push(b28[_g18++]);
			}
			break;
		case 10:
			var val1 = v[4];
			...
			if(st == null) {
				...
				var b10 = haxe_io_Bytes.ofString(st);
				...
				var _g19 = 0;
				var _g20 = b10.length;
				while(_g19 < _g20) _this9.b.push(b29[_g19++]);
			}
			if(val1 == null) {
				ctx.out.b.push(0);
			} else {
				var b11 = haxe_io_Bytes.ofString(val1);
				var v14 = b11.length + 1;
				if(v14 >= 0 && v14 < 128) {
					ctx.out.b.push(v14);
				} else {
					ctx.out.b.push(128);
				...
				var _g110 = 0;
				var _g21 = b11.length;
				while(_g110 < _g21) _this10.b.push(b210[_g110++]);
			}
			break;
		case 11:
			var name4 = v[3];
			...
			if(name4 == null) {
				...
				var b12 = haxe_io_Bytes.ofString(name4);
				var v15 = b12.length + 1;
				if(v15 >= 0 && v15 < 128) {
					ctx.out.b.push(v15);
				} else {
					ctx.out.b.push(128);
				...
				var _g111 = 0;
				var _g22 = b12.length;
				while(_g111 < _g22) _this11.b.push(b211[_g111++]);
			}
			break;
		case 12:
			var eid1 = v[5];
			...
			if(name5 == null) {
				...
				var b13 = haxe_io_Bytes.ofString(name5);
				var v16 = b13.length + 1;
				if(v16 >= 0 && v16 < 128) {
					ctx.out.b.push(v16);
				} else {
					ctx.out.b.push(128);
				...
				var _g112 = 0;
				var _g23 = b13.length;
				while(_g112 < _g23) _this12.b.push(b212[_g112++]);
			}
			if(args == null) {
				ctx.out.b.push(0);
			} else {
				var v17 = args.length + 1;
				if(v17 >= 0 && v17 < 128) {
					ctx.out.b.push(v17);
				} else {
					ctx.out.b.push(128);
		...
		case 13:
			...
			if(name6 == null) {
				...
				var b14 = haxe_io_Bytes.ofString(name6);
				var v19 = b14.length + 1;
				if(v19 >= 0 && v19 < 128) {
					ctx.out.b.push(v19);
				} else {
					ctx.out.b.push(128);
					ctx.out.addInt32(v19);
				}
				var _this13 = ctx.out;
				var b213 = b14.b;
				var _g113 = 0;
				var _g25 = b14.length;
				while(_g113 < _g25) _this13.b.push(b213[_g113++]);
			}
			if(dur == null) {
				ctx.out.b.push(0);
			} else {
		...
		case 16:
			...
			if(msg == null) {
				...
				while(_g28 < msg.length) {
					var v25 = msg[_g28];
					++_g28;
					hxbit_enumSer_vdom_$Message.doSerialize(ctx,v25);
				}
			}
			break;
		case 17:
...
hxbit_enumSer_vdom_$Message.doUnserialize = function(ctx) {
	...
	case 17:
		...
		if(len18 == 0) {
			...
			var _g5 = len18;
			while(_g14 < _g5) {
				e4 = hxbit_enumSer_vdom_$Message.doUnserialize(ctx);
				a4[_g14++] = e4;
			}
			_msg = a4;
		}
	...
	case 18:
		...
		_id15 = v44;
		return vdom_Message.SetVal(_id15,ctx.getDynamic());
	default:
		throw new js__$Boot_HaxeError("Invalid enum index " + b);
	}
};
	...
	init: function() {
		...
		while(_g2 < _g11.length) {
			...
			if(_g21[1] == 6) {
				...
				g.fromSheet(this.level.model.smap.get(_g21[2]).s,16711680);
