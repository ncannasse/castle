...
cdb_jq_Message.SetCSS = function(css) { var $x = ["SetCSS",5,css]; $x.__enum__ = cdb_jq_Message; return $x; };
...
cdb_jq_Message.SlideToogle = function(id,dur) { var $x = ["SlideToogle",14,id,dur]; $x.__enum__ = cdb_jq_Message; return $x; };
var cdb_jq_Answer = $hxClasses["cdb.jq.Answer"] = { __ename__ : ["cdb","jq","Answer"], __constructs__ : ["Event","SetValue"] };
cdb_jq_Answer.Event = function(id,props) { var $x = ["Event",0,id,props]; $x.__enum__ = cdb_jq_Answer; return $x; };
