	...
	,getConvFunction: function(old,t) {
		...
		case 17:
			...
			case 5:
				...
				while(_g11 < _g2) {
					var i2 = _g11++;
					var key2 = values1[i2].toLowerCase();
					if(__map_reserved[key2] != null) map1.setReserved(key2,i2); else map1.h[key2] = i2;
				}
				conv = function(s1) {
		...
		case 3:
			...
			case 5:
				var values3 = t[2];
				conv = function(i3) {
					if(i3 < 0 || i3 >= values3.length) return null; else return i3;
				};
				break;
			case 11:
				conv = function(i4) {
		...
		case 5:
			...
			case 5:
				...
				var _g4 = [];
				var _g25 = 0;
				var _g15 = values14.length;
				while(_g25 < _g15) {
					var i5 = _g25++;
					_g4.push({ name : values14[i5], i : i5});
				}
				var tmp = _g4;
				var _g14 = [];
				var _g35 = 0;
				var _g26 = values2.length;
				while(_g35 < _g26) {
					var i6 = _g35++;
					_g14.push({ name : values2[i6], i : i6});
				}
				var _g3 = this.makePairs(tmp,_g14);
				while(_g24 < _g3.length) {
					var p = _g3[_g24];
					++_g24;
			...
			case 10:
				var val1 = old[2];
				var val2 = t[2];
				if(Std.string(val1) == Std.string(val2)) conv = function(i8) {
					return 1 << i8;
				}; else return null;
				break;
			default:
		...
		case 10:
			...
			case 10:
				...
				var _g8 = [];
				var _g29 = 0;
				var _g19 = values18.length;
				while(_g29 < _g19) {
					var i9 = _g29++;
					_g8.push({ name : values18[i9], i : i9});
				}
				var tmp8 = _g8;
				var _g18 = [];
				var _g39 = 0;
				var _g210 = values28.length;
				while(_g39 < _g210) {
					var i10 = _g39++;
					_g18.push({ name : values28[i10], i : i10});
				}
				var _g38 = this.makePairs(tmp8,_g18);
				while(_g28 < _g38.length) {
					var p10 = _g38[_g28];
					++_g28;
					if(p10.b == null) continue;
					map8[p10.a.i] = p10.b.i;
				}
				conv = function(i11) {
					var out = 0;
					var k = 0;
					while(i11 >= 1 << k) {
						if(map8[k] != null && (i11 & 1 << k) != 0) out |= 1 << map8[k];
						++k;
					}
					return out;
				};
